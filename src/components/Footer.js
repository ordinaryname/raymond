        ...
        <div className="footer-sections">
          <div className="footer-section">
            <div className="footer-section-center">
              ...
              <span className="footer-section-item">Contact Me</span>
              <span className="footer-section-item">Privacy Policy</span>
              <span className="footer-section-item">Terms of Use</span>
            </div>
          </div>
          <div className="footer-section">
            <div className="footer-section-center">
              ...
              <div><img className="linkedin_logo" src={linkedin_logo} alt="linkedin logo"/></div>
            </div>
          </div>
        </div>
