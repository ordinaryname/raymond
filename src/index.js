  ...
  projectMenuHTML = () => {
    ...
    return(
        <div
          ...
          <a href="https://tictactoeplus.com" className="project-menu-item">Tic Tac Toe Plus</a>
        </div>
    );
  }

  changeBackgroundColor = (event, string) => {
      ...
      <div className="body" style={{
        ...
        <div className="content">
          <div className="social-icons">
            <div href="https://github.com/ordinaryname" className="github_thumbnail" onMouseEnter={() => this.setState({backgroundColor:'#aeeaee'})} onMouseLeave={() => this.setState({backgroundColor:'#eeeeee'})}>
